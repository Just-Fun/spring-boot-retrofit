...
Now you can create a web com.serzh.controller for a simple web application.
...
== Create an com.serzh.Application class
Here you create an `com.serzh.Application` class with the components:

`src/main/java/hello/com.serzh.Application.java`
[source,java]
----
include::initial/src/main/java/hello/com.serzh.Application.java[]
----
